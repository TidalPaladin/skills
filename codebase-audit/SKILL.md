...
- `references/security-audit.md` for the required current advisory check.
...
Perform a cursory, read-only pass over repository layout, manifests, primary modules, tests, benchmarks, CI, documentation, and dependency surfaces. Run a lightweight current advisory check. Return a high-level list of provisional areas to investigate.
...
2. Advisory check date, sources or scanners, results, and incomplete surfaces.
