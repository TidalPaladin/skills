...
For a run defensibly estimated before dispatch to take strictly more than 10 minutes, or when the user explicitly requests durable wake delivery, select one run-specific post-run validation and failure-notification path before dispatch:
